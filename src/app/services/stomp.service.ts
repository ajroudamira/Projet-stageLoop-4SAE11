...
export class StompService {
  ...
  constructor() {
    ...
    this.client = new Client({
      brokerURL: 'ws://localhost:8089/louay/ws',  // L'URL WebSocket du backend Spring Boot
      connectHeaders: {},
      debug: function (str) { console.log(str); },
      webSocketFactory: () => new SockJS('http://localhost:8089/louay/ws'),  // Utilisation de SockJS
      onConnect: (frame) => {
